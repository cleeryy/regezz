...
export const advancedLessons: Lesson[] = [
  ...
  { input: 'ftp://wrong.com', shouldMatch: true, explanation: 'Matches "wrong.com" as substring (optional protocol)' },
  { input: 'https://', shouldMatch: false, explanation: 'No domain after protocol' },
  { input: 'httpss://example.com', shouldMatch: true, explanation: 'Matches "example.com" as substring' },
  { input: 'HTTPS://example.com', shouldMatch: true, explanation: 'Matches "example.com" as substring' },
  { input: 'HTTP://example.com', shouldMatch: true, explanation: 'Matches "example.com" as substring' },
